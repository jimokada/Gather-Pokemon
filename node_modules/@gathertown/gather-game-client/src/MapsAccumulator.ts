...
import { ServerClientEventEvent } from "@gathertown/gather-game-common/dist/src/public/utils";
      ...
      case "mapSetObjects": {
        ...
        for (const stringKey in wireObjects) {
          ...
          try {
            ...
            logger.warn(
              `this badly formated wire object is being ignored because it caused conversion error ${logger.errString(
                err,
              )} : ${logger.errString(wireObjects[key])}`,
            );
          }
        }
        break;
