...
var Game = (function () {
    function Game(spaceId, getAuth, onInput, dispatchGameUpdate, dispatchMapUpdate, options) {
        ...
        this.subscriptionFailedCallback = function (reason) {
        ...
        this.eventSubscriptions = DefaultSubscriptions_1.defaultSubscriptions;
        ...
        this.engine.onevent = function (serverClientEvent) {
            ...
            switch (event.$case) {
                ...
                case "spaceSetsIdMapping": {
                    var _f = event.spaceSetsIdMapping, uid = _f.uid, encId = _f.encId;
                ...
                case "transactionStatus":
                    break;
                default: {
                    var eventAny_1 = event;
                    var eventVal = eventAny_1[eventAny_1.$case];
                    var encId = eventVal === null || eventVal === void 0 ? void 0 : eventVal.encId;
                    if (event.$case.startsWith("map")) {
                        var completedMap_1 = _this.mapsAccumulator.addChunk(event);
                        if (!completedMap_1) {
                            break;
                        }
                        (_c = _this.dispatchMapUpdate) === null || _c === void 0 ? void 0 : _c.call(_this, completedMap_1.id, completedMap_1);
                        ...
                        Object.values((_d = _this.legacySubscriptions) !== null && _d !== void 0 ? _d : {}).forEach(function (f) {
                            if (!_this.timeToFirstOnMapsMs[completedMap_1.id]) {
                                _this.timeToFirstOnMapsMs[completedMap_1.id] = Date.now() - _this._connectedAtMs;
                                _this.putMetric("time-to-first-map-data-ms", {
                                    mapId: completedMap_1.id,
                                    timeToMapDataMs: _this.timeToFirstOnMapsMs[completedMap_1.id]
                                });
                                _this.mapDataCheckInterval && clearInterval(_this.mapDataCheckInterval);
                            }
                            if (!_this._onMapCounts[completedMap_1.id]) {
                                _this._onMapCounts[completedMap_1.id] = 0;
                            }
                            _this._onMapCounts[completedMap_1.id] += 1;
                            f.onMap(completedMap_1.id, (0, gameMap_1.convertGameMapV2ToGameMap)(completedMap_1));
                        });
                    }
                        ...
                        if (fetchedUid != null) {
                            ...
                            Logger_1.logger.error("missing encId ".concat(encId, " for event: ").concat(eventAny_1.$case));
                        }
                        if (eventVal === null || eventVal === void 0 ? void 0 : eventVal.encIdTarget) {
                            ...
                            if (uidTarget != null) {
                                ...
                                Logger_1.logger.error("missing encTargetId: ".concat(eventVal === null || eventVal === void 0 ? void 0 : eventVal.encIdTarget, " in event: ").concat(eventAny_1.$case));
                            }
                        }
            ...
            (_e = _this.dispatchGameUpdate) === null || _e === void 0 ? void 0 : _e.call(_this, playerDeltas);
            var eventAny = event[event.$case];
            if (eventAny["encId"]) {
                var encId = eventAny.encId;
                var uid = _this._encIdMapping[encId];
                context.player = context.player || _this.players[uid];
            ...
            if (eventAny["mapId"]) {
                ...
                context.map = _this.partialMaps[mapId];
            }
    ...
    Game.prototype.connect = function () {
        ...
        this.updateSubscriptionsPromise = new Promise(function (res, rej) {
            _this.subscriptionFinishedCallback = res;
            _this.subscriptionFailedCallback = rej;
        });
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, this.updateSubscriptionsPromise];
    ...
    Game.prototype.subscribeToEvent = function (eventId, handler) {
        var _this = this;
    ...
    Game.prototype.setOpenToConversation = function (openToConversation, targetId) {
        this.engine.sendAction({
    ...
    Game.prototype.editChatMessage = function (message) {
        this.engine.sendAction({
    ...
    Game.prototype.setGoKartId = function (goKartId, targetId) {
        var _a;
        (_a = this.engine) === null || _a === void 0 ? void 0 : _a.sendAction({
            $case: "setGoKartId",
            setGoKartId: {
    ...
    Game.prototype.subscribeToAll = function () {
        ...
        this.engine
            ...
            .then(function () {
            Logger_1.logger.log("Finished subscribing.");
            _this.subscriptionFinishedCallback();
        })["catch"](function (reason) {
            _this.subscriptionFailedCallback(reason);
        });
    };
    ...
    Game.prototype.filterObjectsInMap = function (mapId, filter) {
        ...
        if (!map.objects) {
            throw new Error("Can't filter objects in map: haven't gotten objects yet for ".concat(mapId, ". Put this in a mapSetsObjects event handler to ensure objects have arrived first."));
        }
    ...
    Game.prototype.patchGatherEventsSpaceSession = function (playerUpdatesSession) {
        this.engine.sendAction({
