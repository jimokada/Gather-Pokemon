            ...
            case "mapSetObjects": {
                ...
                for (var stringKey in wireObjects) {
                    ...
                    try {
                        ...
                        Logger_1.logger.warn("this badly formated wire object is being ignored because it caused conversion error ".concat(Logger_1.logger.errString(err), " : ").concat(Logger_1.logger.errString(wireObjects[key])));
                    }
                }
                break;
            }
