...
var Engine = (function () {
                ...
                switch (_a.label) {
                    ...
                    case 5:
                        ...
                        try {
                            ...
                            Logger_1.logger.error("Failed to create websocket connection to gameserver ".concat(this.serverURL, " : ").concat(Logger_1.logger.errString(e)));
                            this.cleanUpAndQueueReconnect();
                            return [2];
                        }
                        Logger_1.logger.checkpoint("t: ".concat(Date.now() - this.connectionInitTime, " : created ws connection"));
                        ...
                        this.ws.onopen = function () {
                            ...
                            if (_this.disconnectedStartTime) {
                                _this._timeSpentDisconnected.push(Date.now() - _this.disconnectedStartTime);
                            }
    ...
    Engine.prototype.destroyConnection = function (disconnectInfo) {
        ...
        if (this.ws) {
            ...
            try {
                if (((_a = disconnectInfo === null || disconnectInfo === void 0 ? void 0 : disconnectInfo.code) !== null && _a !== void 0 ? _a : 0) >= 4000) {
    ...
    Engine.prototype.sendAction = function (action, bypass, createTxnId, txnId) {
        ...
        if (createTxnId) {
            transaction = this.transactionManager.addTransaction(!this._connected);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!!this.preferredRegion) return [3, 4];
                        _a.label = 1;
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4, (0, Utils_1.findClosestRegion)()];
                    case 2:
                        res = _a.sent();
                        if (res) {
                            Logger_1.logger.checkpoint("t: ".concat(Date.now() - this.connectionInitTime, " : found closestRegion"));
                            this.preferredRegion = res.closestRegion;
                            this.preferredRegionPing = res.ping;
                        }
                        return [3, 4];
                    case 3:
                        e_2 = _a.sent();
                        Logger_1.logger.error("error finding closestRegion: " + Logger_1.logger.errString(e_2));
                        return [3, 4];
                    case 4: return [4, (0, Utils_1.fetchGameServerAssignment)(this.spaceId, this.preferredRegion)];
                    case 5:
                        serverURL = _a.sent();
                        return [2, serverURL];
                }
