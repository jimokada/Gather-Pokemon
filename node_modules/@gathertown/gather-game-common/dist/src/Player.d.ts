...
import { SpriteDirectionEnum_ENUM as SpriteDirection, MoveDirectionEnum_ENUM as MoveDirection } from "./generated_DO_NOT_TOUCH/events";
...
export declare const CONSTANT_PERMANANT_EMOTES: string[];
