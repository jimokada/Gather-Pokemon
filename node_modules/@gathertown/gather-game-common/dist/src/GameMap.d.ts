...
export declare class GameMap extends GameMapBase {
    collisions: string;
    objects?: MapObject[];
}
...
export declare class GameMapV2 extends GameMapBase {
    collisions: boolean[][];
    objects?: {
...
export declare function convertGameMapV2ToGameMap(mapV2: GameMapV2): GameMap;
export declare function collisionsMatrixToString(collisions: boolean[][]): string;
