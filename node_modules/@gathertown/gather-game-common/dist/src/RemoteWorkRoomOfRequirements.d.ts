...
export declare enum FutureSocialRoom {
}
export declare const gateCuratedRorBySpaceId: (spaceId: string) => boolean;
export declare const NEW_ROR_EXPERIENCE = SocialRoom.Trivia;
export declare const NEXT_PLANNED_ROR_EXPERIENCE = SocialRoom.SpeedGathering;
export declare const ROR_EXPERIENCE_RESET_DATE: Date;
export declare const getNumDaysUntilNextExperience: () => number;
