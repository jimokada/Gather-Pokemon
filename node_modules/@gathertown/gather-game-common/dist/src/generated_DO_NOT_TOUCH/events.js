...
exports.SpaceUserInfo = {
    encode: function (message, writer) {
        ...
        if (message.openToConversation !== undefined) {
            writer.uint32(96).bool(message.openToConversation);
        }
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 11:
                    ...
                    break;
                case 12:
                    message.openToConversation = reader.bool();
                    break;
                case 13:
...
exports.ServerClientEvent = {
    encode: function (message, writer) {
        ...
        if (((_50 = message.event) === null || _50 === void 0 ? void 0 : _50.$case) === "playerSetsOpenToConversation") {
            exports.PlayerSetsOpenToConversation.encode(message.event.playerSetsOpenToConversation, writer.uint32(770).fork()).ldelim();
        }
        if (((_51 = message.event) === null || _51 === void 0 ? void 0 : _51.$case) === "playerBlocks") {
            exports.PlayerBlocks.encode(message.event.playerBlocks, writer.uint32(778).fork()).ldelim();
        }
        if (((_52 = message.event) === null || _52 === void 0 ? void 0 : _52.$case) === "playerUpdatesFocusModeStatus") {
            exports.PlayerUpdatesFocusModeStatus.encode(message.event.playerUpdatesFocusModeStatus, writer.uint32(786).fork()).ldelim();
        }
        if (((_53 = message.event) === null || _53 === void 0 ? void 0 : _53.$case) === "playerNotifies") {
            exports.PlayerNotifies.encode(message.event.playerNotifies, writer.uint32(794).fork()).ldelim();
        }
        if (((_54 = message.event) === null || _54 === void 0 ? void 0 : _54.$case) === "playerSetsItemString") {
            exports.PlayerSetsItemString.encode(message.event.playerSetsItemString, writer.uint32(866).fork()).ldelim();
        }
        if (((_55 = message.event) === null || _55 === void 0 ? void 0 : _55.$case) === "playerTriggersItem") {
            exports.PlayerTriggersItem.encode(message.event.playerTriggersItem, writer.uint32(874).fork()).ldelim();
        }
        if (((_56 = message.event) === null || _56 === void 0 ? void 0 : _56.$case) === "playerSetsFollowTarget") {
            exports.PlayerSetsFollowTarget.encode(message.event.playerSetsFollowTarget, writer.uint32(882).fork()).ldelim();
        }
        if (((_57 = message.event) === null || _57 === void 0 ? void 0 : _57.$case) === "playerRequestsToLead") {
            exports.PlayerRequestsToLead.encode(message.event.playerRequestsToLead, writer.uint32(890).fork()).ldelim();
        }
        if (((_58 = message.event) === null || _58 === void 0 ? void 0 : _58.$case) === "playerSetsManualVideoSrc") {
            exports.PlayerSetsManualVideoSrc.encode(message.event.playerSetsManualVideoSrc, writer.uint32(898).fork()).ldelim();
        }
        if (((_59 = message.event) === null || _59 === void 0 ? void 0 : _59.$case) === "playerSetsIsNpc") {
            exports.PlayerSetsIsNpc.encode(message.event.playerSetsIsNpc, writer.uint32(906).fork()).ldelim();
        }
        if (((_60 = message.event) === null || _60 === void 0 ? void 0 : _60.$case) === "playerSetsSubtitle") {
            exports.PlayerSetsSubtitle.encode(message.event.playerSetsSubtitle, writer.uint32(914).fork()).ldelim();
        }
        if (((_61 = message.event) === null || _61 === void 0 ? void 0 : _61.$case) === "mapCommitsChanges") {
    ...
    decode: function (input, length) {
        ...
        while (reader.pos < end) {
            ...
            switch (tag >>> 3) {
                ...
                case 96:
                    message.event = {
                        $case: "playerSetsOpenToConversation",
                        playerSetsOpenToConversation: exports.PlayerSetsOpenToConversation.decode(reader, reader.uint32())
                    };
                    break;
                case 97:
                    message.event = {
...
var basePlayerSetsOpenToConversation = { encId: 0, openToConversation: false };
exports.PlayerSetsOpenToConversation = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_1["default"].Writer.create(); }
        if (message.encId !== 0) {
            writer.uint32(8).uint32(message.encId);
        }
        if (message.openToConversation === true) {
            writer.uint32(16).bool(message.openToConversation);
        }
        return writer;
    },
    decode: function (input, length) {
        var reader = input instanceof minimal_1["default"].Reader ? input : new minimal_1["default"].Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = __assign({}, basePlayerSetsOpenToConversation);
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.ClientServerAction = {
    encode: function (message, writer) {
        ...
        if (((_46 = message.action) === null || _46 === void 0 ? void 0 : _46.$case) === "setOpenToConversation") {
            exports.SetOpenToConversation.encode(message.action.setOpenToConversation, writer.uint32(650).fork()).ldelim();
        }
        if (((_47 = message.action) === null || _47 === void 0 ? void 0 : _47.$case) === "block") {
            exports.Block.encode(message.action.block, writer.uint32(658).fork()).ldelim();
        }
        if (((_48 = message.action) === null || _48 === void 0 ? void 0 : _48.$case) === "setItemString") {
            exports.SetItemString.encode(message.action.setItemString, writer.uint32(666).fork()).ldelim();
        }
        if (((_49 = message.action) === null || _49 === void 0 ? void 0 : _49.$case) === "triggerItem") {
            exports.TriggerItem.encode(message.action.triggerItem, writer.uint32(674).fork()).ldelim();
        }
        if (((_50 = message.action) === null || _50 === void 0 ? void 0 : _50.$case) === "notify") {
            exports.Notify.encode(message.action.notify, writer.uint32(682).fork()).ldelim();
        }
        if (((_51 = message.action) === null || _51 === void 0 ? void 0 : _51.$case) === "setFollowTarget") {
            exports.SetFollowTarget.encode(message.action.setFollowTarget, writer.uint32(690).fork()).ldelim();
        }
        if (((_52 = message.action) === null || _52 === void 0 ? void 0 : _52.$case) === "requestToLead") {
            exports.RequestToLead.encode(message.action.requestToLead, writer.uint32(698).fork()).ldelim();
        }
        if (((_53 = message.action) === null || _53 === void 0 ? void 0 : _53.$case) === "enterPortal") {
            exports.EnterPortal.encode(message.action.enterPortal, writer.uint32(706).fork()).ldelim();
        }
        if (((_54 = message.action) === null || _54 === void 0 ? void 0 : _54.$case) === "setManualVideoSrc") {
            exports.SetManualVideoSrc.encode(message.action.setManualVideoSrc, writer.uint32(714).fork()).ldelim();
        }
        if (((_55 = message.action) === null || _55 === void 0 ? void 0 : _55.$case) === "setSubtitle") {
            ...
            switch (tag >>> 3) {
                ...
                case 81:
                    message.action = {
                        ...
                        setOpenToConversation: exports.SetOpenToConversation.decode(reader, reader.uint32())
                    };
                    break;
                case 82:
...
var baseSetOpenToConversation = { openToConversation: false };
exports.SetOpenToConversation = {
    encode: function (message, writer) {
        if (writer === void 0) { writer = minimal_1["default"].Writer.create(); }
        if (message.openToConversation === true) {
            writer.uint32(8).bool(message.openToConversation);
        }
        if (message.targetId !== undefined) {
            writer.uint32(18).string(message.targetId);
        }
    ...
    decode: function (input, length) {
        var reader = input instanceof minimal_1["default"].Reader ? input : new minimal_1["default"].Reader(input);
        var end = length === undefined ? reader.len : reader.pos + length;
        var message = __assign({}, baseSetOpenToConversation);
        while (reader.pos < end) {
            var tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
exports.Respawn = {
    encode: function (message, writer) {
        ...
        if (message.isNpc !== undefined) {
            writer.uint32(32).bool(message.isNpc);
        }
        return writer;
    },
    decode: function (input, length) {
