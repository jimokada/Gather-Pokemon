...
exports.verifyMapIsComplete = exports.convertStringToPresetTutorialGroupSetId = exports.convertTutorialTasksToWireTutorialTasks = exports.convertWireTutorialTasksToTutorialTasks = exports.PresetTutorialGroupSetIds = exports.convertStringToEnabledChat = exports.wallFloorConvertToDB = exports.wallFloorConvertFromDB = exports.collisionsMatrixToString = exports.convertGameMapV2ToGameMap = exports.EnabledChat = exports.areaToCoords = exports.interactionOpensModal = exports.TileType = exports.convertCoordsToBBoxes = exports.convertDesksToDBDesks = exports.convertDBDesksToDesks = exports.generateEmptyDeskCoordsMap = exports.convertDBDesksCoordsToCoordsMap = exports.convertAreaCoordsToCoordsMap = exports.convertWireAreasToAreas = exports.convertWireAreasToDBAreas = exports.AreaCategory = exports.convertMapObjectToWireObject = exports.convertWireObjectToMapObject = exports.convertWireObjectToMapObjectDB = exports.findMissingMapObjectFields = exports.Tile = exports.WallFloorDB = exports.FloorBlock = exports.WallBlock = exports.GameMapV2 = exports.GameMap = exports.Interaction = void 0;
var lodash_1 = require("lodash");
var buffer_1 = require("buffer");
var Position_1 = require("./Position");
var events_1 = require("./generated_DO_NOT_TOUCH/events");
exports.Interaction = events_1.InteractionEnum_ENUM;
var GameMapBase = (function () {
    function GameMapBase() {
    }
    return GameMapBase;
}());
...
var GameMapV2 = (function (_super) {
    __extends(GameMapV2, _super);
    function GameMapV2() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return GameMapV2;
}(GameMapBase));
exports.GameMapV2 = GameMapV2;
...
function convertGameMapV2ToGameMap(mapV2) {
    var _a;
    var objArray = Object.keys((_a = mapV2.objects) !== null && _a !== void 0 ? _a : {})
        .sort(function (key1, key2) { return parseInt(key1) - parseInt(key2); })
        .map(function (key) { var _a; return (_a = mapV2.objects) === null || _a === void 0 ? void 0 : _a[key]; });
    var collisions = collisionsMatrixToString(mapV2.collisions);
    return __assign(__assign({}, mapV2), { objects: objArray, collisions: collisions });
}
exports.convertGameMapV2ToGameMap = convertGameMapV2ToGameMap;
function collisionsMatrixToString(collisions) {
    var collBytes = [];
    for (var r = 0; r < collisions.length; r++) {
        for (var c = 0; c < collisions[0].length; c++) {
            collBytes.push(collisions[r][c] ? 0x01 : 0x00);
        }
    }
    return new buffer_1.Buffer(collBytes).toString("base64");
}
exports.collisionsMatrixToString = collisionsMatrixToString;
