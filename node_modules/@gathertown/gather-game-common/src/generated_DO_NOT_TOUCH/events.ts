...
export interface SpaceUserInfo {
  ...
  openToConversation?: boolean | undefined;
...
export interface ServerClientEvent {
  event?:
    ...
    | {
        ...
        playerSetsOpenToConversation: PlayerSetsOpenToConversation;
      }
...
export interface PlayerSetsOpenToConversation {
  encId: number;
...
export interface ClientServerAction {
  ...
  action?:
    ...
    | { $case: "setOpenToConversation"; setOpenToConversation: SetOpenToConversation }
...
export interface SetOpenToConversation {
  openToConversation: boolean;
  targetId?: string | undefined;
}
...
export const ServerClientEvent = {
  encode(message: ServerClientEvent, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.event?.$case === "playerSetsOpenToConversation") {
      PlayerSetsOpenToConversation.encode(
        message.event.playerSetsOpenToConversation,
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 96:
          message.event = {
            $case: "playerSetsOpenToConversation",
            playerSetsOpenToConversation: PlayerSetsOpenToConversation.decode(
              reader,
              reader.uint32(),
            ),
          };
...
const basePlayerSetsOpenToConversation: object = { encId: 0, openToConversation: false };

export const PlayerSetsOpenToConversation = {
  encode(
    message: PlayerSetsOpenToConversation,
    writer: _m0.Writer = _m0.Writer.create(),
  ): _m0.Writer {
    if (message.encId !== 0) {
      writer.uint32(8).uint32(message.encId);
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): PlayerSetsOpenToConversation {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...basePlayerSetsOpenToConversation } as PlayerSetsOpenToConversation;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
...
export const ClientServerAction = {
  encode(message: ClientServerAction, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    ...
    if (message.action?.$case === "setOpenToConversation") {
      SetOpenToConversation.encode(
        message.action.setOpenToConversation,
      ...
      switch (tag >>> 3) {
        ...
        case 81:
          message.action = {
            ...
            setOpenToConversation: SetOpenToConversation.decode(reader, reader.uint32()),
          };
          break;
        case 82:
...
const baseSetOpenToConversation: object = { openToConversation: false };

export const SetOpenToConversation = {
  encode(message: SetOpenToConversation, writer: _m0.Writer = _m0.Writer.create()): _m0.Writer {
    if (message.openToConversation === true) {
  ...
  decode(input: _m0.Reader | Uint8Array, length?: number): SetOpenToConversation {
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = { ...baseSetOpenToConversation } as SetOpenToConversation;
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
