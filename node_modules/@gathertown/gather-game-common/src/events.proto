...
message SpaceUserInfo {
  ...
  optional bool openToConversation = 12;
...
message ServerClientEvent {
  oneof event {
    ...
    PlayerSetsGoKartId playerSetsGoKartId = 57; // experimental
    ...
    PlayerSetsOpenToConversation playerSetsOpenToConversation = 96;
...
message ClientServerAction {
  ...
  oneof action {
    ...
    SetGoKartId setGoKartId = 42; // experimental
    ...
    SetOpenToConversation setOpenToConversation = 81;
    Block block = 82;
...
message SetOpenToConversation {
  bool openToConversation = 1;
  optional string targetId = 2;
}
