...
export enum FutureSocialRoom {}

// half of all spaces with an ror should auto-update based on NEW_ROR_EXPERIENCE
export const gateCuratedRorBySpaceId = (spaceId: string) => spaceId.charCodeAt(0) % 2 === 1;
export const NEW_ROR_EXPERIENCE = SocialRoom.Trivia;
export const NEXT_PLANNED_ROR_EXPERIENCE = SocialRoom.SpeedGathering;
export const ROR_EXPERIENCE_RESET_DATE = new Date("2022-02-28");
export const getNumDaysUntilNextExperience = () => {
  const diff = ROR_EXPERIENCE_RESET_DATE.getTime() - new Date().getTime();
...
export const SocialRoomInfo: {
  [roomKey in SocialRoom | FutureSocialRoom]: {
    caption: string;
    imageURL: string;
    guideURL: string;
...
// Future links
// Poker Night: https://support.gather.town/help/poker-night?utm_source=template&utm_medium=app&utm_campaign=experiences
